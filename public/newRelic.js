...
NREUM.loader_config = {
  ...
  trustKey: '4559971',
  agentID: '601485799',
  licenseKey: 'NRBR-a95cc6898f9ab366762',
  applicationID: '601485799',
};
NREUM.info = {
...
(() => {
        ...
        function i(e, t) {
          try {
            if (!e || 'object' != typeof e)
              return (0, n.R)('Setting a Configurable requires an object as input');
      ...
      8941: (e, t, r) => {
        ...
        function T(e) {
          ...
          return (
            !a.RI ||
              R[t.debugId]++ ||
              ((R[t.debugId] = 1), (0, i.YM)(t).inPlace(window.history, A, '-')),
            t
          );
        }
        var E = r(3878);
                ...
                return (
                  Object.values(e.initializedAgents).forEach((e) => {
                    e && e.api
                      ...
                      : (0, d.R)(
                          "Call to api '".concat(t, "' made before agent fully initialized.")
                        );
                  }),
                  o.length > 1 ? o : o[0]
                );
            ...
            void 0 === e.api &&
              (e.api = (function (e, t) {
                ...
                (g.log = function (e) {
                  ...
                  (g.start = () => {
                    try {
                      (0, o.p)(l.xV, ['API/start/called'], void 0, n.K.metrics, w),
  ...
  (i.m = r),
    ...
    (i.u = (e) =>
      ({ 212: 'nr-spa-compressor', 249: 'nr-spa-recorder', 478: 'nr-spa' })[e] + '-1.262.0.min.js'),
      ...
      class b extends f.W {
        constructor(e, t, r) {
          ...
          super(e, t, r),
            ...
            !1 === (0, s.gD)(this.agentIdentifier, ''.concat(this.featureName, '.autoStart')) &&
              (this.auto = !1),
            this.auto
              ? (0, l.Ak)(e, r)
              : this.ee.on(
        ...
        constructor(e, r) {
          ...
          (0, p.SR)(e) && this.ee.on(t.G4.RECORD, () => this.#o()),
            ...
            this.ee.on('err', (e) => {
              this.replayRunning &&
                ((this.errorNoticed = !0),
                (0, O.p)(t.G4.ERROR_DURING_REPLAY, [e], void 0, this.featureName, this.ee));
            }),
            this.ee.on(t.G4.REPLAY_RUNNING, (e) => {
              ...
              this.ee.on(Se, m),
                ...
                this.ee.on('fn-err', function () {
                  for (var t = arguments.length, n = new Array(t), i = 0; i < t; i++)
                    n[i] = arguments[i];
                  n[2]?.__newrelic?.[e] ||
                    (0, O.p)('function-err', [...n], void 0, r.featureName, r.ee);
                }),
